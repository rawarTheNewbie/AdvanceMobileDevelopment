...
const styles = StyleSheet.create({
  ...
  genderPillActive: { backgroundColor: "#0c4124", borderWidth: 1, borderColor: "#1ed760" },
  ...
  signUpWith: { color: "#18b857", fontSize: 16, marginTop: 8 },
  socialRow: { width: FIELD_WIDTH, flexDirection: "row", justifyContent: "center", gap: 20, marginTop: 8 },
  socialCircle: {
    width: 56,
    height: 56,
    borderRadius: 28,
